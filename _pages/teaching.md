...
Microeconomic Theory (all levels), Macroeconomic Theory (undergraduate), Game Theory and Behavior (all levels),  and an interest course in Computational Modeling and Methods in Python (all levels).
